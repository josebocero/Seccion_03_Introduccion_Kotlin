...
class Functions {
    ...
    private fun showCaase2() {
        ...
        // Si el callback recibe sólo un parámetro, podemos omitir ese "result" -> it
    ...
    private fun showCase6() {
        ...
        // Si es declarada dentro de estre método, sólo tenemos acceso a él en este mismo contexto de función
        fun String.welcome() {
