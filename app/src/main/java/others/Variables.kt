...
Las variables pueden ser mutables o inmutables, usaremos inmutables siempre que sean posible. (var vs val)
...
class Variables {
    ...
    private fun showCase1() {
        Log.w(
            "VARIABLE-0",
            "¿Es variable0 un Integer? -->" + (variable0 is Int) + "¿Y por qué no un byte"
        )
